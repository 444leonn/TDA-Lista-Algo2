...
int main(int argc, char *argv[])
{
    ...
    if (pokemones_enlazados == NULL) {
        printf(TROJO"Error, no se ha podido reservar la memoria." TNORMAL"\n");
    }
    ...
    if (strcmp(argv[3], "nombre") == 0) {
        int posicion_pokemon_buscado = lista_buscar_posicion(pokemones_enlazados, argv[4],  comparador_nombres);
